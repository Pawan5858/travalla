...
# from apps.masterentry.models import *
...
#         unique_together = (('gdsk_gude', 'gdsk_skil'),)  # Composite primary key equivalent 
...
#     gddc_doct = models.CharField(DocumentTypes, on_delete=models.CASCADE, null=False, blank=True)
#     gddc_doc_file = models.CharField(max_length=255, null=False)  # File path or URL
#     gddc_uploaded_at = models.DateTimeField(auto_now_add=True)
#     gddc_status = models.CharField(max_length=4, default='ACTV')  # Active or any other status

#     class Meta:
#         db_table = 'guide_documents'
#         unique_together = (('gddc_gude', 'gddc_doct'),)  # Add this constraint
